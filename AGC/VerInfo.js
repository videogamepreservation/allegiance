...
// Determine which, if any, file name was specified on the command line
var strFileName = WScript.Arguments.Count() ? WScript.Arguments(0) : "";

// Create the VersionInfo object
var objVerInfo = new ActiveXObject("AGC.AGCVersionInfo");  

// Load the specified file name, if one was specified
if ("" != strFileName)
  objVerInfo.FileName = strFileName;
